...
Contributions are welcome. Start with [CONTRIBUTING.md](CONTRIBUTING.md), discuss substantial changes in an issue, and run `./scripts/check.sh` before opening a pull request.
